    ...
    <v-container class="pa-0 pb-5">
        <v-layout wrap align-center justify-center row fill-height>
            ...
            <v-flex xs12 md12 class="mt-3">
                <p class="google-font my-2" style="font-size:110%">Companies Partner</p>
                                ...
                                <v-layout row wrap class="ma-0 pa-0">
                                    ...
                                    <v-card flat tile class="d-flex pa-2 ma-1 elevation-1" style="border-radius:4px;border-width: 0px; border-style: solid;">
                                        ...
                                        <v-tooltip bottom>
                                            <template v-slot:activator="{ on }">
                                        <v-img
                                            :src="require('@/assets/img/partners/synesthesia.png')"
                                            :lazy-src="require('@/assets/img/partners/synesthesia.png')"
                                            aspect-ratio="3.0"
                                            class="white"
                                            v-on="on"
                                        >
                                        ...
                                        <span class="google-font">Synesthesia srl</span>
                                        </v-tooltip>
                                        </a>
                                    </v-card>
                                     ...
                                     <v-card flat tile class="d-flex pa-2 ma-1 elevation-1" style="border-radius:4px;border-width: 0px; border-style: solid;">
                                        ...
                                        <v-tooltip bottom>
                                            <template v-slot:activator="{ on }">
                                        <v-img
                                            :src="require('@/assets/img/partners/corley.png')"
                                            :lazy-src="require('@/assets/img/partners/corley.png')"
                                            aspect-ratio="3.0"
                                            class="white"
                                            v-on="on"
                                        >
                                        ...
                                        <span class="google-font">Corley srl</span>
                                        </v-tooltip>
                                        </a>
                                    </v-card>
